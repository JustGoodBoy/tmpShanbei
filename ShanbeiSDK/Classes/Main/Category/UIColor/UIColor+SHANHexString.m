...
@implementation UIColor (SHANHexString)

+ (nullable UIColor *)shan_colorWithHexString:(NSString *)hexString {
    return [self shan_colorWithHexString:hexString alphaComponent:1.0];
}

+ (UIColor *)shan_colorWithHexString:(NSString *)hexString alphaComponent:(CGFloat)alphaComponent {
    // 删除字符串中的空格
...
- (NSString *)shan_hexadecimalString {
    UIColor* color = self;
